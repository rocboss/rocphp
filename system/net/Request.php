...
class Request
{
    ...
    /**
     * @var \system\util\Collection Query string parameters
     */
    public $query;

    /**
     * @var \system\util\Collection Post parameters
     */
    public $data;

    /**
     * @var \system\util\Collection Cookie parameters
     */
    public $cookies;

    /**
     * @var \system\util\Collection Uploaded files
     */
    public $files;
    ...
    public function init($properties = [])
    {
        ...
        if (empty($this->url)) {
            $this->url = '/';
        } else { // Merge URL query parameters with $_GET
