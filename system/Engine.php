...
class Engine {
    ...
    public function init() {
        ...
        $this->loader->register('view', '\system\template\View', array(), function($view) use ($self) {
            $view->path = $self->get('system.views.path');
            $view->extension = $self->get('system.views.extension');
        });
    ...
    public function _start() {
        ...
        $router->case_sensitive = $this->get('system.case_sensitive');
