...
class DB
{
    # 可以使用 MySQL, MariaDB, MSSQL, Sybase, PostgreSQL, Oracle
    ...
    public function set_connection($options = null)
    {
        try
        {
            $commands = array();
    ...
    public function checkResult($affected)
    {
