...
class DBEngine
{
    ...
    {
        static $joins = array('INNER', 'LEFT OUTER', 'RIGHT OUTER', 'FULL OUTER');
    ...
    public function sql($sql = null)
    {
        if ($sql !== null)
        {
            $this->sql = trim((is_array($sql)) ? array_reduce($sql, array(
                $this,
                'build'
            )) : $sql);
    ...
    public function getProperties()
    {
        ...
        {
            static $defaults = array('table' => null, 'id_field' => null, 'name_field' => null);
